...
<body>
	...
	<div class="container text-center">
		<h4>Bienvenido a Planizator:</h4>
		<img class="img-responsive img-rounded center-block" src="img/selfie.jpg"
			width="500px" />
		<p>Esta web de planes es privada, solo pueden acceder a ella
			usuarios registrados.</p>
		<p>Si ya tienes una cuenta inicia sesion, si es la primera vez que
			entras, registrate.</p>
